...
#define FC_NOT_IMPLEMENTED_STRING L"NOT_IMPLEMENTED"

#define ARGC_ARGV_KEYWORDS_LIST_DEFINE CONFIGURATION_PACKAGE_NAME, SECTION_NAME_DEFINE, SERVICE_ENDPOINT_RESOURCE
