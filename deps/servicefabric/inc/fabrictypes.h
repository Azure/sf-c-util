...
enum FABRIC_ERROR_CODE
    {
        ...
        FABRIC_E_LAST_USED_FACILITY_SF_HRESULT	= FABRIC_E_SKIP_RESTORE_OPERATION,
...
typedef struct FABRIC_DEPLOYED_APPLICATION_QUERY_RESULT_ITEM_EX3
    {
    LPCWSTR ApplicationTypeVersion;
    void *Reserved;
    } 	FABRIC_DEPLOYED_APPLICATION_QUERY_RESULT_ITEM_EX3;
