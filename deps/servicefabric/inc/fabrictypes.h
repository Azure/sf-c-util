...
enum FABRIC_ERROR_CODE
    {
        ...
        FABRIC_E_FACILITY_SF_FIRST_HRESULT	= 0x87b00000,
        FABRIC_E_INSTANCE_ALREADY_EXISTS	= FABRIC_E_FACILITY_SF_FIRST_HRESULT,
        FABRIC_E_NODE_TYPE_NOT_FOUND	= ( FABRIC_E_INSTANCE_ALREADY_EXISTS + 1 ) ,
        FABRIC_E_INSTANCE_COUNT_UPDATE_NOT_ALLOWED	= ( FABRIC_E_NODE_TYPE_NOT_FOUND + 1 ) ,
        FABRIC_E_COPY_ABORTED	= ( FABRIC_E_INSTANCE_COUNT_UPDATE_NOT_ALLOWED + 1 ) ,
        FABRIC_E_AUXILIARY_ALREADY_EXISTS	= ( FABRIC_E_COPY_ABORTED + 1 ) ,
        FABRIC_E_AUXILIARY_FEATURE_DISABLED	= ( FABRIC_E_AUXILIARY_ALREADY_EXISTS + 1 ) ,
        FABRIC_E_RUN_TO_COMPLETION_INCOMPATIBLE_WITH_SHARED_PROCESS	= ( FABRIC_E_AUXILIARY_FEATURE_DISABLED + 1 ) ,
        FABRIC_E_VERSION_STORE_OUT_OF_MEMORY	= ( FABRIC_E_RUN_TO_COMPLETION_INCOMPATIBLE_WITH_SHARED_PROCESS + 1 ) ,
        FABRIC_E_BACKUP_NOT_FOUND	= ( FABRIC_E_VERSION_STORE_OUT_OF_MEMORY + 1 ) ,
        FABRIC_E_SKIP_RESTORE_OPERATION	= ( FABRIC_E_BACKUP_NOT_FOUND + 1 ) ,
        FABRIC_E_STORE_OUT_OF_SESSIONS	= ( FABRIC_E_SKIP_RESTORE_OPERATION + 1 ) ,
        FABRIC_E_RESTORE_WAITING_FOR_USER_INTERVENTION	= ( FABRIC_E_STORE_OUT_OF_SESSIONS + 1 ) ,
        FABRIC_E_DATABASE_FILES_CORRUPTED	= ( FABRIC_E_RESTORE_WAITING_FOR_USER_INTERVENTION + 1 ) ,
        FABRIC_E_INSUFFICIENT_MAX_LOAD_CAPACITY	= ( FABRIC_E_DATABASE_FILES_CORRUPTED + 1 ) ,
        FABRIC_E_STORE_DISK_ERROR	= ( FABRIC_E_INSUFFICIENT_MAX_LOAD_CAPACITY + 1 ) ,
        FABRIC_E_SERVICE_ALREADY_IN_REQUESTED_STATE	= ( FABRIC_E_STORE_DISK_ERROR + 1 ) ,
        FABRIC_E_DISABLE_ENABLE_SERVICE_FEATURE_DISABLED	= ( FABRIC_E_SERVICE_ALREADY_IN_REQUESTED_STATE + 1 ) ,
        FABRIC_E_MAX_ALLOWED_DISABLED_SERVICES_REACHED	= ( FABRIC_E_DISABLE_ENABLE_SERVICE_FEATURE_DISABLED + 1 ) ,
        FABRIC_E_SERVICE_DISABLED	= ( FABRIC_E_MAX_ALLOWED_DISABLED_SERVICES_REACHED + 1 ) ,
        FABRIC_E_SERVICE_DISABLE_IN_PROGRESS	= ( FABRIC_E_SERVICE_DISABLED + 1 ) ,
        FABRIC_E_STORE_OUT_OF_LONG_VALUE_IDS	= ( FABRIC_E_SERVICE_DISABLE_IN_PROGRESS + 1 ) ,
        FABRIC_E_STORE_OUT_OF_INSTANCES	= ( FABRIC_E_STORE_OUT_OF_LONG_VALUE_IDS + 1 ) ,
        FABRIC_E_STORE_SERIALIZED_STREAM_NULL	= ( FABRIC_E_STORE_OUT_OF_INSTANCES + 1 ) ,
        FABRIC_E_STORE_SERIALIZATION_ERROR	= ( FABRIC_E_STORE_SERIALIZED_STREAM_NULL + 1 ) ,
        FABRIC_E_INCOMPATIBLE_EXCLUSIVE_SELF_RECONFIGURING	= ( FABRIC_E_STORE_SERIALIZATION_ERROR + 1 ) ,
        FABRIC_E_LAST_USED_FACILITY_SF_HRESULT	= FABRIC_E_INCOMPATIBLE_EXCLUSIVE_SELF_RECONFIGURING,
...
enum FABRIC_CLIENT_ROLE
    {
        ...
        FABRIC_CLIENT_ROLE_ELEVATED_ADMIN	= 0x4
    } 	FABRIC_CLIENT_ROLE;
...
enum FABRIC_QUERY_SERVICE_STATUS
    {
        ...
        FABRIC_QUERY_SERVICE_STATUS_DISABLING	= 0x6,
        FABRIC_QUERY_SERVICE_STATUS_DISABLED	= 0x7
...
enum FABRIC_SERVICE_KIND
    {
        ...
        FABRIC_SERVICE_KIND_SELF_RECONFIGURING	= 0x3
    } 	FABRIC_SERVICE_KIND;
...
enum FABRIC_QUERY_SERVICE_PARTITION_STATUS
    {
        ...
        FABRIC_QUERY_SERVICE_PARTITION_STATUS_DISABLING	= 0x6,
        FABRIC_QUERY_SERVICE_PARTITION_STATUS_DISABLED	= 0x7
...
enum FABRIC_QUERY_SERVICE_REPLICA_STATUS
    {
        ...
        FABRIC_QUERY_SERVICE_REPLICA_STATUS_COMPLETED	= 0x6
...
enum FABRIC_QUERY_SERVICE_REPLICA_STATUS_FILTER
    {
        ...
        FABRIC_QUERY_SERVICE_REPLICA_STATUS_FILTER_COMPLETED	= 0x20
...
enum FABRIC_REPLICA_ROLE
    {
        ...
        FABRIC_REPLICA_ROLE_IDLE_AUXILIARY	= 0x5,
        FABRIC_REPLICA_ROLE_ACTIVE_AUXILIARY	= 0x6,
        FABRIC_REPLICA_ROLE_PRIMARY_AUXILIARY	= 0x7
    } 	FABRIC_REPLICA_ROLE;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("1b9d48a2-5c54-4429-a2b0-c3956281eff9") 
enum FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE
    {
        FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE_NONE	= 0,
        FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE_INITIAL	= 0x1,
        FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE_MEMBER	= 0x2
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE;
...
enum FABRIC_REPLICATOR_SETTINGS_FLAGS
    {
        ...
        FABRIC_REPLICATOR_ENABLE_SEND_WINDOW_SIZE_IN_BYTES	= 0x400000,
        FABRIC_REPLICATOR_USE_INDIVIDUAL_HEAP_PER_REPLICA	= 0x800000,
        FABRIC_REPLICATOR_INITIAL_REPLICA_HEAP_SIZE_IN_KB	= 0x1000000,
        FABRIC_REPLICATOR_REPLICATION_BATCH_SIZE	= 0x2000000,
        FABRIC_REPLICATOR_REPLICATION_BATCH_SEND_INTERVAL	= 0x4000000
...
enum FABRIC_HEALTH_REPORT_KIND
    {
        ...
        FABRIC_HEALTH_REPORT_KIND_SELF_RECONFIGURING_SERVICE_INSTANCE	= 0xa
...
enum FABRIC_HEALTH_EVALUATION_KIND
    {
        ...
        FABRIC_HEALTH_EVALUATION_KIND_NODE_TYPE_NODES	= 0x16
...
enum FABRIC_SERVICE_ENDPOINT_ROLE
    {
        ...
        FABRIC_SERVICE_ROLE_STATEFUL_PRIMARY_AUXILIARY	= 0x4,
        FABRIC_SERVICE_ROLE_STATEFUL_AUXILIARY	= 0x5,
        FABRIC_SERVICE_ROLE_SELF_RECONFIGURING	= 0x6
...
enum FABRIC_SERVICE_DESCRIPTION_KIND
    {
        ...
        FABRIC_SERVICE_DESCRIPTION_KIND_SELF_RECONFIGURING	= 0x3
...
enum FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_FLAGS
    {
        ...
        FABRIC_STATEFUL_SERVICE_SETTINGS_SERVICE_PLACEMENT_TIME_LIMIT	= 0x8,
        FABRIC_STATEFUL_SERVICE_SETTINGS_DROP_SOURCE_REPLICA_ON_MOVE	= 0x10,
        FABRIC_STATEFUL_SERVICE_SETTINGS_IS_SINGLETON_REPLICA_MOVE_ALLOWED_DURING_UPGRADE	= 0x20,
        FABRIC_STATEFUL_SERVICE_SETTINGS_RESTORE_REPLICA_LOCATION_AFTER_UPGRADE	= 0x40,
        FABRIC_STATEFUL_SERVICE_SETTINGS_AUXILIARY_REPLICA_COUNT	= 0x80,
        FABRIC_STATEFUL_SERVICE_SETTINGS_SERVICE_SENSITIVITY	= 0x100
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_FLAGS;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("8f0834c2-820d-4b51-8982-48a0ca4ca9af") 
enum FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS_FLAGS
    {
        FABRIC_STATELESS_SERVICE_SETTINGS_NONE	= 0,
        FABRIC_STATELESS_SERVICE_SETTINGS_INSTANCE_CLOSE_DELAY_DURATION	= 0x1,
        FABRIC_STATELESS_SERVICE_SETTINGS_INSTANCE_RESTART_WAIT_DURATION	= 0x2
...
enum FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_FLAGS
    {
        ...
        FABRIC_STATELESS_SERVICE_MIN_INSTANCE_COUNT	= 0x80,
        FABRIC_STATELESS_SERVICE_MIN_INSTANCE_PERCENTAGE	= 0x100,
        FABRIC_STATELESS_SERVICE_INSTANCE_CLOSE_DELAY_DURATION	= 0x200,
        FABRIC_STATELESS_SERVICE_INSTANCE_RESTART_WAIT_DURATION	= 0x400,
        FABRIC_STATELESS_SERVICE_SERVICE_DNS_NAME	= 0x800,
        FABRIC_STATELESS_SERVICE_RESTORE_REPLICA_LOCATION_AFTER_UPGRADE	= 0x1000,
        FABRIC_STATELESS_SERVICE_TAGS_REQUIRED_TO_PLACE	= 0x2000,
        FABRIC_STATELESS_SERVICE_TAGS_REQUIRED_TO_RUN	= 0x4000
...
enum FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_FLAGS
    {
        ...
        FABRIC_STATEFUL_SERVICE_SERVICE_PLACEMENT_TIME_LIMIT	= 0x800,
        FABRIC_STATEFUL_SERVICE_DROP_SOURCE_REPLICA_ON_MOVE	= 0x1000,
        FABRIC_STATEFUL_SERVICE_SERVICE_DNS_NAME	= 0x2000,
        FABRIC_STATEFUL_SERVICE_IS_SINGLETON_REPLICA_MOVE_ALLOWED_DURING_UPGRADE	= 0x4000,
        FABRIC_STATEFUL_SERVICE_RESTORE_REPLICA_LOCATION_AFTER_UPGRADE	= 0x8000,
        FABRIC_STATEFUL_SERVICE_TAGS_REQUIRED_TO_PLACE	= 0x10000,
        FABRIC_STATEFUL_SERVICE_TAGS_REQUIRED_TO_RUN	= 0x20000,
        FABRIC_STATEFUL_SERVICE_AUXILIARY_REPLICA_COUNT	= 0x40000,
        FABRIC_STATEFUL_SERVICE_SERVICE_SENSITIVITY	= 0x80000
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_FLAGS;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("fa879e89-efd8-42bc-842f-bb4264c380a6") 
enum FABRIC_SELF_RECONFIGURING_SERVICE_UPDATE_DESCRIPTION_FLAGS
    {
        FABRIC_SELF_RECONFIGURING_SERVICE_NONE	= 0,
        FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_COUNT	= 0x1,
        FABRIC_SELF_RECONFIGURING_SERVICE_MIN_INSTANCE_COUNT	= 0x2,
        FABRIC_SELF_RECONFIGURING_SERVICE_PLACEMENT_CONSTRAINTS	= 0x4,
        FABRIC_SELF_RECONFIGURING_SERVICE_POLICY_LIST	= 0x8,
        FABRIC_SELF_RECONFIGURING_SERVICE_CORRELATIONS	= 0x10,
        FABRIC_SELF_RECONFIGURING_SERVICE_METRICS	= 0x20,
        FABRIC_SELF_RECONFIGURING_SERVICE_MOVE_COST	= 0x40,
        FABRIC_SELF_RECONFIGURING_SERVICE_SCALING_POLICY	= 0x80,
        FABRIC_SELF_RECONFIGURING_SERVICE_SERVICE_DNS_NAME	= 0x100,
        FABRIC_SELF_RECONFIGURING_SERVICE_RESTORE_REPLICA_LOCATION_AFTER_UPGRADE	= 0x200,
        FABRIC_SELF_RECONFIGURING_SERVICE_TAGS_REQUIRED_TO_PLACE	= 0x400,
        FABRIC_SELF_RECONFIGURING_SERVICE_TAGS_REQUIRED_TO_RUN	= 0x800,
        FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_RESTART_WAIT_DURATION	= 0x1000
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_UPDATE_DESCRIPTION_FLAGS;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("cad07520-2813-4ac8-90b2-7b1b2aec1c7f") 
enum FABRIC_SELF_RECONFIGURING_INSTANCE_OPEN_MODE
    {
        FABRIC_SELF_RECONFIGURING_INSTANCE_OPEN_MODE_INVALID	= 0,
        FABRIC_SELF_RECONFIGURING_INSTANCE_OPEN_MODE_NEW	= 0x1,
        FABRIC_SELF_RECONFIGURING_INSTANCE_OPEN_MODE_EXISTING	= 0x2
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_OPEN_MODE;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("52cb6b21-9f0c-412b-a644-0d6e65c6a6a0") 
enum FABRIC_SELF_RECONFIGURING_INSTANCE_ACTIVATION_STATE
    {
        FABRIC_SELF_RECONFIGURING_INSTANCE_STATE_INVALID	= 0,
        FABRIC_SELF_RECONFIGURING_INSTANCE_STATE_ACTIVATED	= 0x1,
        FABRIC_SELF_RECONFIGURING_INSTANCE_STATE_DEACTIVATED	= 0x2
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("79f550e0-f028-4459-a22a-f2f64860ded5") 
enum FABRIC_UPGRADE_SORT_ORDER
    {
        FABRIC_UPGRADE_SORT_ORDER_INVALID	= 0,
        FABRIC_UPGRADE_SORT_ORDER_DEFAULT	= 0x1,
        FABRIC_UPGRADE_SORT_ORDER_NUMERIC	= 0x2,
        FABRIC_UPGRADE_SORT_ORDER_LEXICOGRAPHICAL	= 0x3,
        FABRIC_UPGRADE_SORT_ORDER_REVERSE_NUMERIC	= 0x4,
        FABRIC_UPGRADE_SORT_ORDER_REVERSE_LEXICOGRAPHICAL	= 0x5
    } 	FABRIC_UPGRADE_SORT_ORDER;
...
enum FABRIC_ROLLING_UPGRADE_MODE
    {
        ...
        FABRIC_ROLLING_UPGRADE_MODE_UNMONITORED_DEFERRED	= 0x4
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("7b04d70a-763d-4a0b-97c6-b9b905550d24") 
enum FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE
    {
        FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE_INVALID	= 0,
        FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE_WAIT_DURATION	= 0x1,
        FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE_STABLE_DURATION	= 0x2,
        FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE_RETRY	= 0x3
...
enum FABRIC_ROLLING_UPGRADE_UPDATE_FLAGS
    {
        ...
        FABRIC_ROLLING_UPGRADE_UPDATE_FLAGS_INSTANCE_CLOSE_DELAY_DURATION	= 0x2000
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("fc80e723-d9cc-426c-3e7d-62f776bbb3f8") 
enum FABRIC_SERVICE_DISABLE_FLAG
    {
        FABRIC_SERVICE_DISABLE_FLAG_INVALID	= 0,
        FABRIC_SERVICE_DISABLE_FLAG_REMOVE_DATA	= 0x1
    } 	FABRIC_SERVICE_DISABLE_FLAG;
...
enum FABRIC_DEPLOYMENT_STATUS
    {
        ...
        FABRIC_DEPLOYMENT_STATUS_RAN_TO_COMPLETION	= 0x6,
        FABRIC_DEPLOYMENT_STATUS_FAILED	= 0x7
...
enum FABRIC_REPAIR_NODE_IMPACT_LEVEL
    {
        ...
        FABRIC_REPAIR_NODE_IMPACT_LEVEL_PAUSE	= 0x5
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("f60efa04-a12b-4fc4-ab28-027789801f7f") 
enum FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND
    {
        FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND_INVALID	= 0,
        FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND_USING_NODE_NAME	= 0x1,
        FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND_USING_REPLICA_SELECTOR	= 0x2
    } 	FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("8a7ae9c7-17f7-4ee3-99db-3b42a855ceab") 
enum FABRIC_MOVE_AUXILIARY_DESCRIPTION_KIND
    {
        FABRIC_MOVE_AUXILIARY_DESCRIPTION_KIND_INVALID	= 0,
        FABRIC_MOVE_AUXILIARY_DESCRIPTION_KIND_USING_NODE_NAME	= 0x1,
        FABRIC_MOVE_AUXILIARY_DESCRIPTION_KIND_USING_REPLICA_SELECTOR	= 0x2
...
enum FABRIC_PLACEMENT_POLICY_TYPE
    {
        ...
        FABRIC_PLACEMENT_POLICY_ALLOW_MULTIPLE_STATELESS_INSTANCES_ON_NODE	= 0x6
...
typedef struct FABRIC_SERVICE_LOAD_METRIC_DESCRIPTION_EX1
    {
    ULONG AuxiliaryDefaultLoad;
    void *Reserved;
    } 	FABRIC_SERVICE_LOAD_METRIC_DESCRIPTION_EX1;

typedef struct FABRIC_SERVICE_LOAD_METRIC_DESCRIPTION_EX2
    {
    ULONG MaximumLoad;
    void *Reserved;
    } 	FABRIC_SERVICE_LOAD_METRIC_DESCRIPTION_EX2;
...
typedef struct FABRIC_PLACEMENT_POLICY_ALLOW_MULTIPLE_STATELESS_INSTANCES_ON_NODE_DESCRIPTION
    {
    void *Reserved;
    } 	FABRIC_PLACEMENT_POLICY_ALLOW_MULTIPLE_STATELESS_INSTANCES_ON_NODE_DESCRIPTION;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_TYPE_DESCRIPTION
    {
    LPCWSTR ServiceTypeName;
    LPCWSTR PlacementConstraints;
    const FABRIC_SERVICE_LOAD_METRIC_DESCRIPTION_LIST *LoadMetrics;
    ...
    FABRIC_SERVICE_PLACEMENT_POLICY_LIST *PolicyList;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_TYPE_DESCRIPTION;

typedef struct FABRIC_SELF_RECONFIGURING_CONFIGURATION_REPORT_ID
    {
    LONGLONG SequenceNumber;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_CONFIGURATION_REPORT_ID;

typedef struct FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST_ID
    {
    LONGLONG GenerationNumber;
    LONGLONG SequenceNumber;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST_ID;

typedef struct FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION
    {
    FABRIC_INSTANCE_ID InstanceId;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE Role;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ACTIVATION_STATE ActivationState;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION;

typedef struct FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION *Items;
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION_LIST;

typedef struct FABRIC_SELF_RECONFIGURING_CONFIGURATION_REPORT
    {
    FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST_ID RequestId;
    FABRIC_SELF_RECONFIGURING_CONFIGURATION_REPORT_ID ReportId;
    const FABRIC_SELF_RECONFIGURING_INSTANCE_INFORMATION_LIST *Instances;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_CONFIGURATION_REPORT;

typedef struct FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST
    {
    FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST_ID RequestId;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST;

typedef struct FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST
    {
    FABRIC_INSTANCE_ID InstanceId;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE Role;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE RequestedRole;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ACTIVATION_STATE ActivationState;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ACTIVATION_STATE RequestedActivationState;
    LPCWSTR Endpoints;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST;

typedef struct FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST *Items;
    } 	FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST_LIST;

typedef struct FABRIC_SELF_RECONFIGURING_CONFIGURATION_CHANGE_REQUEST
    {
    FABRIC_SELF_RECONFIGURING_CONFIGURATION_REQUEST_ID RequestId;
    const FABRIC_SELF_RECONFIGURING_INSTANCE_CHANGE_REQUEST_LIST *Instances;
    void *Reserved;
...
typedef struct FABRIC_CONFIGURATION_PARAMETER_OVERRIDE
    {
    LPCWSTR SectionName;
    LPCWSTR ParameterName;
    LPCWSTR ParameterValue;
    DWORD Timeout;
    BOOLEAN PersistAcrossUpgrade;
    void *Reserved;
    } 	FABRIC_CONFIGURATION_PARAMETER_OVERRIDE;

typedef struct FABRIC_CONFIGURATION_PARAMETER_OVERRIDE_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_CONFIGURATION_PARAMETER_OVERRIDE *Items;
    } 	FABRIC_CONFIGURATION_PARAMETER_OVERRIDE_LIST;

typedef struct NODE_TYPE_PLACEMENT_CONSTRAINT
    {
    LPCWSTR NodePropertyName;
    LPCWSTR NodePropertyValue;
    void *Reserved;
    } 	NODE_TYPE_PLACEMENT_CONSTRAINT;

typedef struct NODE_TYPE_PLACEMENT_CONSTRAINT_LIST
    {
    ULONG Count;
    /* [size_is] */ const NODE_TYPE_PLACEMENT_CONSTRAINT *Items;
    } 	NODE_TYPE_PLACEMENT_CONSTRAINT_LIST;
...
typedef struct FABRIC_REPLICATOR_SETTINGS_EX5
    {
    BOOLEAN EnableSendWindowSizeInBytes;
    DWORD MaxReplicationQueueSendWindowSizeInBytes;
    DWORD MaxCopyQueueSendWindowSizeInBytes;
    BOOLEAN UseIndividualHeapPerReplica;
    void *Reserved;
    } 	FABRIC_REPLICATOR_SETTINGS_EX5;

typedef struct FABRIC_REPLICATOR_SETTINGS_EX6
    {
    DWORD InitialReplicaHeapSizeInKB;
    void *Reserved;
    } 	FABRIC_REPLICATOR_SETTINGS_EX6;

typedef struct FABRIC_REPLICATOR_SETTINGS_EX7
    {
    DWORD ReplicationBatchSize;
    DWORD ReplicationBatchSendIntervalMilliseconds;
    void *Reserved;
    } 	FABRIC_REPLICATOR_SETTINGS_EX7;
...
typedef struct FABRIC_START_NODE_POISON_DESCRIPTION
    {
    LPCWSTR NodeId;
    FABRIC_NODE_INSTANCE_ID NodeInstanceId;
    FABRIC_STRING_LIST *Neighbors;
    void *Reserved;
    } 	FABRIC_START_NODE_POISON_DESCRIPTION;
...
typedef struct FABRIC_DISABLE_SERVICE_DESCRIPTION
    {
    FABRIC_URI ServiceName;
    FABRIC_SERVICE_DISABLE_FLAG DisableServiceFlag;
    BOOLEAN ForceDisable;
    void *Reserved;
    } 	FABRIC_DISABLE_SERVICE_DESCRIPTION;
...
typedef struct FABRIC_NODE_UPGRADE_PROGRESS_EX1
    {
    DWORD UpgradeDurationInSeconds;
    void *Reserved;
    } 	FABRIC_NODE_UPGRADE_PROGRESS_EX1;
...
typedef struct INSTANCE_LIFECYCLE_DESCRIPTION
    {
    BOOLEAN IsRestoreReplicaLocationAfterUpgradeSpecified;
    BOOLEAN RestoreReplicaLocationAfterUpgrade;
    void *Reserved;
    } 	INSTANCE_LIFECYCLE_DESCRIPTION;

typedef struct REPLICA_LIFECYCLE_DESCRIPTION
    {
    BOOLEAN IsIsSingletonReplicaMoveAllowedDuringUpgradeSpecified;
...
typedef struct FABRIC_SERVICE_TAGS_DESCRIPTION
    {
    FABRIC_STRING_LIST *TagsRequiredToPlace;
    FABRIC_STRING_LIST *TagsRequiredToRun;
    void *Reserved;
    } 	FABRIC_SERVICE_TAGS_DESCRIPTION;

typedef struct SERVICE_SENSITIVITY_DESCRIPTION
    {
    ULONG PrimaryDefaultSensitivity;
    ULONG SecondaryDefaultSensitivity;
    ULONG AuxiliaryDefaultSensitivity;
    BOOLEAN IsMaximumSensitivity;
    void *Reserved;
    } 	SERVICE_SENSITIVITY_DESCRIPTION;

typedef struct FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS
    {
    DWORD Flags;
    DWORD InstanceCloseDelayDurationSeconds;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS;

typedef struct FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS_EX1
    {
    DWORD InstanceRestartWaitDurationSeconds;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS_EX1;

typedef struct FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS_EX2
    {
    INSTANCE_LIFECYCLE_DESCRIPTION *InstanceLifecycleDescription;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS_EX2;
...
typedef struct FABRIC_STATELESS_SERVICE_DESCRIPTION_EX5
    {
    LONG MinInstanceCount;
    LONG MinInstancePercentage;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_DESCRIPTION_EX5;

typedef struct FABRIC_STATELESS_SERVICE_DESCRIPTION_EX6
    {
    FABRIC_STATELESS_SERVICE_FAILOVER_SETTINGS *FailoverSettings;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_DESCRIPTION_EX6;

typedef struct FABRIC_STATELESS_SERVICE_DESCRIPTION_EX7
    {
    FABRIC_SERVICE_TAGS_DESCRIPTION *TagsDescription;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_DESCRIPTION_EX7;

typedef struct FABRIC_STATELESS_SERVICE_DESCRIPTION_EX8
    {
    BOOLEAN IsCreateAsDisabled;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_DESCRIPTION_EX8;
...
typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX4
    {
    LONG MinInstanceCount;
    LONG MinInstancePercentage;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX4;

typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX5
    {
    DWORD InstanceCloseDelayDurationSeconds;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX5;

typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX6
    {
    DWORD InstanceRestartWaitDurationSeconds;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX6;

typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX7
    {
    LPCWSTR ServiceDnsName;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX7;

typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX8
    {
    INSTANCE_LIFECYCLE_DESCRIPTION *InstanceLifecycleDescription;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX8;

typedef struct FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX9
    {
    FABRIC_SERVICE_TAGS_DESCRIPTION *TagsDescription;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_UPDATE_DESCRIPTION_EX9;
...
typedef struct FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX2
    {
    DWORD ServicePlacementTimeLimitSeconds;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX2;

typedef struct FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX3
    {
    BOOLEAN DropSourceReplicaOnMove;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX3;

typedef struct FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX4
    {
    REPLICA_LIFECYCLE_DESCRIPTION *ReplicaLifecycleDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX4;

typedef struct FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX5
    {
    LONG AuxiliaryReplicaCount;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX5;

typedef struct FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX6
    {
    SERVICE_SENSITIVITY_DESCRIPTION *ServiceSensitivityDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_FAILOVER_SETTINGS_EX6;
...
typedef struct FABRIC_STATEFUL_SERVICE_DESCRIPTION_EX5
    {
    FABRIC_SERVICE_TAGS_DESCRIPTION *TagsDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_DESCRIPTION_EX5;

typedef struct FABRIC_STATEFUL_SERVICE_DESCRIPTION_EX6
    {
    BOOLEAN IsCreateAsDisabled;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_DESCRIPTION_EX6;
...
typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX6
    {
    DWORD ServicePlacementTimeLimitSeconds;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX6;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX7
    {
    BOOLEAN DropSourceReplicaOnMove;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX7;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX8
    {
    LPCWSTR ServiceDnsName;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX8;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX9
    {
    REPLICA_LIFECYCLE_DESCRIPTION *ReplicaLifecycleDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX9;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX10
    {
    FABRIC_SERVICE_TAGS_DESCRIPTION *TagsDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX10;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX11
    {
    LONG AuxiliaryReplicaCount;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX11;

typedef struct FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX12
    {
    SERVICE_SENSITIVITY_DESCRIPTION *ServiceSensitivityDescription;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_UPDATE_DESCRIPTION_EX12;

typedef struct SELF_RECONFIGURING_INSTANCE_LIFECYCLE_DESCRIPTION
    {
    BOOLEAN IsRestoreReplicaLocationAfterUpgradeSpecified;
    BOOLEAN RestoreReplicaLocationAfterUpgrade;
    void *Reserved;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_FAILOVER_SETTINGS
    {
    DWORD Flags;
    SELF_RECONFIGURING_INSTANCE_LIFECYCLE_DESCRIPTION *InstanceLifecycleDescription;
    DWORD InstanceRestartWaitDurationSeconds;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_FAILOVER_SETTINGS;

typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_DESCRIPTION
    {
    FABRIC_URI ApplicationName;
    FABRIC_URI ServiceName;
    LPCWSTR ServiceTypeName;
    ...
    /* [size_is] */ FABRIC_SERVICE_SCALING_POLICY *ServiceScalingPolicies;
    FABRIC_SERVICE_TAGS_DESCRIPTION *TagsDescription;
    FABRIC_SELF_RECONFIGURING_SERVICE_FAILOVER_SETTINGS *FailoverSettings;
    LONG MinInstanceCount;
    LONG InstanceCount;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_DESCRIPTION;

typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_DESCRIPTION_EX1
    {
    BOOLEAN IsCreateAsDisabled;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_DESCRIPTION_EX1;

typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_UPDATE_DESCRIPTION
    {
    DWORD Flags;
    LPCWSTR PlacementConstraints;
    FABRIC_SERVICE_PLACEMENT_POLICY_LIST *PolicyList;
    ...
    DWORD InstanceRestartWaitDurationSeconds;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_UPDATE_DESCRIPTION;
...
typedef struct FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER
    {
    LPCWSTR Name;
    LPCWSTR Identity;
    void *Reserved;
    } 	FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER;

typedef struct FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER *Items;
    } 	FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER_LIST;
...
typedef struct FABRIC_MANAGED_IDENTITY_DESCRIPTION
    {
    LPCWSTR Name;
    LPCWSTR PrincipalId;
    void *Reserved;
    } 	FABRIC_MANAGED_IDENTITY_DESCRIPTION;

typedef struct FABRIC_MANAGED_IDENTITY_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_MANAGED_IDENTITY_DESCRIPTION *Items;
    } 	FABRIC_MANAGED_IDENTITY_DESCRIPTION_LIST;

typedef struct FABRIC_MANAGED_APPLICATION_IDENTITY_DESCRIPTION
    {
    const FABRIC_MANAGED_IDENTITY_DESCRIPTION_LIST *ManagedIdentities;
    LPCWSTR TokenServiceEndpoint;
    void *Reserved;
    } 	FABRIC_MANAGED_APPLICATION_IDENTITY_DESCRIPTION;

typedef struct FABRIC_IDENTITY_BINDING_POLICY_DESCRIPTION
    {
    LPCWSTR ServiceIdentityRef;
    LPCWSTR ApplicationIdentityRef;
    void *Reserved;
    } 	FABRIC_IDENTITY_BINDING_POLICY_DESCRIPTION;

typedef struct FABRIC_DIGESTED_MANAGED_IDENTITY
    {
    LPCWSTR Name;
    const FABRIC_MANAGED_IDENTITY_DESCRIPTION *Identity;
    const FABRIC_IDENTITY_BINDING_POLICY_DESCRIPTION *IdentityBindingPolicy;
    void *Reserved;
    } 	FABRIC_DIGESTED_MANAGED_IDENTITY;

typedef struct FABRIC_DIGESTED_MANAGED_IDENTITY_ITEM
    {
    LPCWSTR ApplicationIdentityName;
    const FABRIC_DIGESTED_MANAGED_IDENTITY *DigestedManagedIdentity;
    void *Reserved;
    } 	FABRIC_DIGESTED_MANAGED_IDENTITY_ITEM;

typedef struct FABRIC_DIGESTED_MANAGED_IDENTITY_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_DIGESTED_MANAGED_IDENTITY_ITEM *Items;
    } 	FABRIC_DIGESTED_MANAGED_IDENTITY_LIST;

typedef struct FABRIC_DIGESTED_MANAGED_IDENTITY_DESCRIPTION
    {
    LPCWSTR TokenServiceEndpoint;
    const FABRIC_MANAGED_IDENTITY_DESCRIPTION *DefaultIdentity;
    const FABRIC_MANAGED_IDENTITY_DESCRIPTION_LIST *WhitelistedIdentities;
    const FABRIC_DIGESTED_MANAGED_IDENTITY_LIST *DigestedManagedIdentities;
    void *Reserved;
    } 	FABRIC_DIGESTED_MANAGED_IDENTITY_DESCRIPTION;

typedef struct FABRIC_MANAGED_IDENTITY_POLICY_BINDING
    {
    LPCWSTR ServiceIdentityRef;
    LPCWSTR ApplicationIdentityRef;
    void *Reserved;
    } 	FABRIC_MANAGED_IDENTITY_POLICY_BINDING;
...
typedef struct FABRIC_APPLICATION_DESCRIPTION_EX2
    {
    const FABRIC_MANAGED_APPLICATION_IDENTITY_DESCRIPTION *ManagedApplicationIdentity;
    void *Reserved;
    } 	FABRIC_APPLICATION_DESCRIPTION_EX2;
...
typedef struct FABRIC_APPLICATION_UPGRADE_DESCRIPTION_EX1
    {
    FABRIC_MANAGED_APPLICATION_IDENTITY_DESCRIPTION *ManagedApplicationIdentity;
    void *Reserved;
    } 	FABRIC_APPLICATION_UPGRADE_DESCRIPTION_EX1;
...
typedef struct FABRIC_KEY_VALUE_STORE_REPLICA_SETTINGS_EX4
    {
    BOOLEAN DisableTombstoneCleanup;
    void *Reserved;
    } 	FABRIC_KEY_VALUE_STORE_REPLICA_SETTINGS_EX4;

typedef struct FABRIC_KEY_VALUE_STORE_REPLICA_SETTINGS_EX5
    {
    LONG LogicalCopyProbabilityInPercent;
    void *Reserved;
    } 	FABRIC_KEY_VALUE_STORE_REPLICA_SETTINGS_EX5;
...
typedef struct FABRIC_ESE_LOCAL_STORE_SETTINGS_EX7
    {
    LONG PoolMinSize;
    LONG PoolAdjustmentSize;
    LONG PoolCachedReadCursorsPerSessionSize;
    LONG PoolEvictionPeriodInSeconds;
    void *Reserved;
    } 	FABRIC_ESE_LOCAL_STORE_SETTINGS_EX7;

typedef struct FABRIC_ESE_LOCAL_STORE_SETTINGS_EX8
    {
    LONG FreePageSizeThresholdInMB;
    LONG CompactionProbabilityInPercent;
    void *Reserved;
    } 	FABRIC_ESE_LOCAL_STORE_SETTINGS_EX8;

typedef struct FABRIC_ESE_LOCAL_STORE_SETTINGS_EX9
    {
    int FreePageSizeThresholdInPercent;
    void *Reserved;
    } 	FABRIC_ESE_LOCAL_STORE_SETTINGS_EX9;
...
typedef struct FABRIC_CLIENT_SETTINGS_EX5
    {
    BOOLEAN AllowHealthReportCleanup;
    ULONG HealthReportDropTransientReportTtlThresholdInSeconds;
    void *Reserved;
...
typedef struct FABRIC_NODE_DEACTIVATION_TASK_EX1
    {
    LPCWSTR Description;
    void *Reserved;
    } 	FABRIC_NODE_DEACTIVATION_TASK_EX1;
...
typedef struct FABRIC_NODE_QUERY_RESULT_ITEM_EX7
    {
    LPCWSTR InfrastructurePlacementID;
    void *Reserved;
    } 	FABRIC_NODE_QUERY_RESULT_ITEM_EX7;

typedef struct FABRIC_NODE_QUERY_RESULT_ITEM_EX8
    {
    FABRIC_STRING_LIST *NodeTags;
    void *Reserved;
    } 	FABRIC_NODE_QUERY_RESULT_ITEM_EX8;

typedef struct FABRIC_NODE_QUERY_RESULT_ITEM_EX9
    {
    BOOLEAN IsNodeByNodeUpgradeInProgress;
    void *Reserved;
    } 	FABRIC_NODE_QUERY_RESULT_ITEM_EX9;
...
typedef struct FABRIC_COMMON_ARM_METADATA
    {
    LPCWSTR ArmResourceId;
    void *Reserved;
    } 	FABRIC_COMMON_ARM_METADATA;

typedef struct FABRIC_APPLICATION_TYPE_ARM_METADATA_UPDATE_DESCRIPTION
    {
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_TYPE_ARM_METADATA_UPDATE_DESCRIPTION;

typedef struct FABRIC_APPLICATION_TYPE_METADATA
    {
    FILETIME ProvisionTimestamp;
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_TYPE_METADATA;
...
typedef struct FABRIC_APPLICATION_TYPE_QUERY_RESULT_ITEM_EX3
    {
    FABRIC_APPLICATION_TYPE_METADATA *Metadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_TYPE_QUERY_RESULT_ITEM_EX3;

typedef struct FABRIC_APPLICATION_TYPE_QUERY_RESULT_ITEM_EX4
    {
    FABRIC_MANAGED_KEY_VAULT_REFERENCE_PARAMETER_LIST *ManagedKeyVaultReferenceParameterList;
    void *Reserved;
    } 	FABRIC_APPLICATION_TYPE_QUERY_RESULT_ITEM_EX4;
...
typedef struct FABRIC_APPLICATION_QUERY_DESCRIPTION_EX5
    {
    BOOLEAN ExcludeManagedApplicationIdentity;
    void *Reserved;
    } 	FABRIC_APPLICATION_QUERY_DESCRIPTION_EX5;

typedef struct FABRIC_APPLICATION_ARM_METADATA_UPDATE_DESCRIPTION
    {
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_ARM_METADATA_UPDATE_DESCRIPTION;

typedef struct FABRIC_APPLICATION_METADATA
    {
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_METADATA;
...
typedef struct FABRIC_APPLICATION_QUERY_RESULT_ITEM_EX3
    {
    const FABRIC_MANAGED_APPLICATION_IDENTITY_DESCRIPTION *ManagedApplicationIdentity;
    void *Reserved;
    } 	FABRIC_APPLICATION_QUERY_RESULT_ITEM_EX3;

typedef struct FABRIC_APPLICATION_QUERY_RESULT_ITEM_EX4
    {
    FABRIC_APPLICATION_METADATA *Metadata;
    void *Reserved;
    } 	FABRIC_APPLICATION_QUERY_RESULT_ITEM_EX4;
...
typedef struct FABRIC_SERVICE_ARM_METADATA_UPDATE_DESCRIPTION
    {
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_SERVICE_ARM_METADATA_UPDATE_DESCRIPTION;

typedef struct FABRIC_SERVICE_METADATA
    {
    FABRIC_COMMON_ARM_METADATA *ArmMetadata;
    void *Reserved;
    } 	FABRIC_SERVICE_METADATA;
...
typedef struct FABRIC_STATELESS_SERVICE_QUERY_RESULT_ITEM_EX3
    {
    FABRIC_SERVICE_METADATA *Metadata;
    void *Reserved;
    } 	FABRIC_STATELESS_SERVICE_QUERY_RESULT_ITEM_EX3;
...
typedef struct FABRIC_STATEFUL_SERVICE_QUERY_RESULT_ITEM_EX3
    {
    FABRIC_SERVICE_METADATA *Metadata;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_QUERY_RESULT_ITEM_EX3;

typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_QUERY_RESULT_ITEM
    {
    FABRIC_URI ServiceName;
    LPCWSTR ServiceTypeName;
    LPCWSTR ServiceManifestVersion;
...
typedef struct FABRIC_STATELESS_SERVICE_PARTITION_QUERY_RESULT_ITEM_EX1
    {
...
typedef struct FABRIC_STATEFUL_SERVICE_PARTITION_QUERY_RESULT_ITEM_EX2
    {
    ULONG AuxiliaryReplicaCount;
    void *Reserved;
    } 	FABRIC_STATEFUL_SERVICE_PARTITION_QUERY_RESULT_ITEM_EX2;

typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_PARTITION_QUERY_RESULT_ITEM
    {
    const FABRIC_SERVICE_PARTITION_INFORMATION *PartitionInformation;
    ULONG InstanceCount;
    FABRIC_HEALTH_STATE HealthState;
    FABRIC_QUERY_SERVICE_PARTITION_STATUS PartitionStatus;
    ULONG MinInstanceCount;
    void *Reserved;
...
typedef struct FABRIC_STATEFUL_SERVICE_REPLICA_QUERY_RESULT_ITEM_EX1
    {
    FABRIC_REPLICA_ROLE PreviousReplicaRole;
    void *Reserved;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_QUERY_RESULT_ITEM
    {
    FABRIC_INSTANCE_ID InstanceId;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE InstanceRole;
    FABRIC_QUERY_SERVICE_REPLICA_STATUS ReplicaStatus;
    FABRIC_HEALTH_STATE AggregatedHealthState;
    LPCWSTR ReplicaAddress;
    LPCWSTR NodeName;
    LONGLONG LastInBuildDurationInSeconds;
    FABRIC_SELF_RECONFIGURING_INSTANCE_ROLE PreviousSelfReconfiguringInstanceRole;
    void *Reserved;
...
typedef struct FABRIC_DEPLOYED_SERVICE_PACKAGE_QUERY_RESULT_ITEM_EX2
    {
    FABRIC_HEALTH_STATE HealthState;
    void *Reserved;
    } 	FABRIC_DEPLOYED_SERVICE_PACKAGE_QUERY_RESULT_ITEM_EX2;
...
typedef struct FABRIC_PAGED_DEPLOYED_SERVICE_PACKAGE_QUERY_DESCRIPTION
    {
    LPCWSTR NodeName;
    FABRIC_URI ApplicationName;
    LPCWSTR ServiceManifestNameFilter;
    ...
    const FABRIC_QUERY_PAGING_DESCRIPTION *PagingDescription;
    void *Reserved;
    } 	FABRIC_PAGED_DEPLOYED_SERVICE_PACKAGE_QUERY_DESCRIPTION;
...
typedef struct FABRIC_CODE_PACKAGE_ENTRY_POINT_EX2
    {
    LPCWSTR ContainerId;
    void *Reserved;
    } 	FABRIC_CODE_PACKAGE_ENTRY_POINT_EX2;
...
typedef struct FABRIC_DEPLOYED_CODE_PACKAGE_QUERY_DESCRIPTION_EX1
    {
    BOOLEAN IncludeCodePackageUsageStats;
    void *Reserved;
    } 	FABRIC_DEPLOYED_CODE_PACKAGE_QUERY_DESCRIPTION_EX1;

typedef struct FABRIC_CODE_PACKAGE_USAGE_STATISTICS
    {
    FABRIC_STRING_MAP *CodePackageStats;
    FILETIME TimeRead;
    void *Reserved;
    } 	FABRIC_CODE_PACKAGE_USAGE_STATISTICS;
...
typedef struct FABRIC_DEPLOYED_CODE_PACKAGE_QUERY_RESULT_ITEM_EX2
    {
    FABRIC_CODE_PACKAGE_USAGE_STATISTICS *CodePackageStats;
    void *Reserved;
    } 	FABRIC_DEPLOYED_CODE_PACKAGE_QUERY_RESULT_ITEM_EX2;
...
typedef struct FABRIC_DEPLOYED_SELF_RECONFIGURING_SERVICE_INSTANCE_QUERY_RESULT_ITEM
    {
    FABRIC_URI ServiceName;
    LPCWSTR ServiceTypeName;
    LPCWSTR ServiceManifestVersion;
    ...
    FABRIC_RECONFIGURATION_INFORMATION_QUERY_RESULT *ReconfigurationInformation;
    void *Reserved;
    } 	FABRIC_DEPLOYED_SELF_RECONFIGURING_SERVICE_INSTANCE_QUERY_RESULT_ITEM;
...
typedef struct FABRIC_DEPLOYED_SELF_RECONFIGURING_SERVICE_INSTANCE_DETAIL_QUERY_RESULT_ITEM
    {
    FABRIC_URI ServiceName;
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_INSTANCE_ID InstanceId;
    ...
    FILETIME CurrentServiceOperationStartTimeUtc;
    FABRIC_LOAD_METRIC_REPORT_LIST *ReportedLoad;
    FABRIC_DEPLOYED_SELF_RECONFIGURING_SERVICE_INSTANCE_QUERY_RESULT_ITEM *DeployedServiceInstance;
    void *Reserved;
    } 	FABRIC_DEPLOYED_SELF_RECONFIGURING_SERVICE_INSTANCE_DETAIL_QUERY_RESULT_ITEM;
...
typedef struct FABRIC_KEY_VALUE_STORE_STATUS_QUERY_RESULT_EX2
    {
    LONGLONG DatabasePhysicalSizeEstimateInBytes;
    void *Reserved;
    } 	FABRIC_KEY_VALUE_STORE_STATUS_QUERY_RESULT_EX2;
...
typedef struct FABRIC_LOADED_PARTITION_INFORMATION_QUERY_RESULT_ITEM
    {
    FABRIC_URI ServiceName;
    FABRIC_PARTITION_ID PartitionId;
    LPCWSTR MetricName;
    ULONG Load;
    void *Reserved;
    } 	FABRIC_LOADED_PARTITION_INFORMATION_QUERY_RESULT_ITEM;

typedef struct FABRIC_LOADED_PARTITION_INFORMATION_QUERY_RESULT_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_LOADED_PARTITION_INFORMATION_QUERY_RESULT_ITEM *Items;
    } 	FABRIC_LOADED_PARTITION_INFORMATION_QUERY_RESULT_LIST;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("2558ba3e-9908-409a-9810-6526afed1ac8") 
enum FABRIC_ORDERING
    {
        FABRIC_ORDERING_DESC	= 0,
        FABRIC_ORDERING_ASC	= 0x1
    } 	FABRIC_ORDERING;

typedef struct FABRIC_LOADED_PARTITION_INFORMATION_QUERY_DESCRIPTION
    {
    LPCWSTR MetricName;
    FABRIC_URI ServiceName;
    FABRIC_ORDERING Ordering;
    FABRIC_QUERY_PAGING_DESCRIPTION *PagingDescription;
    void *Reserved;
    } 	FABRIC_LOADED_PARTITION_INFORMATION_QUERY_DESCRIPTION;

typedef struct FABRIC_BLOCK_LIST_QUERY_RESULT_ITEM
    {
    LPCWSTR NodeName;
    void *Reserved;
    } 	FABRIC_BLOCK_LIST_QUERY_RESULT_ITEM;

typedef struct FABRIC_BLOCK_LIST_QUERY_RESULT_LIST
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_BLOCK_LIST_QUERY_RESULT_ITEM *Items;
    } 	FABRIC_BLOCK_LIST_QUERY_RESULT_LIST;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("555333ae-9908-409a-9810-6526afed1ac8") 
enum FABRIC_BLOCK_LIST_TYPE
    {
        FABRIC_BLOCK_LIST_TYPE_SERVICE	= 0,
        FABRIC_BLOCK_LIST_TYPE_OVERALL	= 0x1,
        FABRIC_BLOCK_LIST_TYPE_PREFERRED_PRIMARY	= 0x2,
        FABRIC_BLOCK_LIST_TYPE_PLACEMENT_TAGS	= 0x3,
        FABRIC_BLOCK_LIST_TYPE_RUNNING_TAGS	= 0x4
    } 	FABRIC_BLOCK_LIST_TYPE;

typedef struct FABRIC_BLOCK_LIST_QUERY_DESCRIPTION
    {
    FABRIC_URI ServiceName;
    FABRIC_BLOCK_LIST_TYPE type;
    FABRIC_QUERY_PAGING_DESCRIPTION *PagingDescription;
    void *Reserved;
    } 	FABRIC_BLOCK_LIST_QUERY_DESCRIPTION;
...
typedef struct FABRIC_MOVE_INSTANCE_DESCRIPTION
    {
    FABRIC_MOVE_INSTANCE_DESCRIPTION_KIND Kind;
    void *Value;
    } 	FABRIC_MOVE_INSTANCE_DESCRIPTION;

typedef struct FABRIC_MOVE_INSTANCE_DESCRIPTION_USING_NODE_NAME
    {
    LPCWSTR CurrentNodeName;
    LPCWSTR NewNodeName;
    FABRIC_URI ServiceName;
    ...
    BOOLEAN IgnoreConstraints;
    void *Reserved;
    } 	FABRIC_MOVE_INSTANCE_DESCRIPTION_USING_NODE_NAME;

typedef struct FABRIC_MOVE_INSTANCE_RESULT
    {
    LPCWSTR CurrentNodeName;
    LPCWSTR NewNodeName;
    FABRIC_URI ServiceName;
    FABRIC_PARTITION_ID PartitionId;
    void *Reserved;
    } 	FABRIC_MOVE_INSTANCE_RESULT;

typedef struct FABRIC_MOVE_AUXILIARY_DESCRIPTION
    {
    FABRIC_MOVE_AUXILIARY_DESCRIPTION_KIND Kind;
    void *Value;
    } 	FABRIC_MOVE_AUXILIARY_DESCRIPTION;

typedef struct FABRIC_MOVE_AUXILIARY_DESCRIPTION_USING_NODE_NAME
    {
    LPCWSTR CurrentNodeName;
    LPCWSTR NewNodeName;
    FABRIC_URI ServiceName;
    ...
    BOOLEAN IgnoreConstraints;
    void *Reserved;
    } 	FABRIC_MOVE_AUXILIARY_DESCRIPTION_USING_NODE_NAME;

typedef struct FABRIC_MOVE_AUXILIARY_RESULT
    {
    LPCWSTR CurrentNodeName;
    LPCWSTR NewNodeName;
    FABRIC_URI ServiceName;
...
typedef struct FABRIC_COMPLETE_REPLICA_DESCRIPTION
    {
    LPCWSTR NodeName;
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_REPLICA_ID ReplicaOrInstanceId;
    void *Reserved;
    } 	FABRIC_COMPLETE_REPLICA_DESCRIPTION;
...
typedef struct FABRIC_HEALTH_INFORMATION_EX1
    {
    LPCWSTR HealthReportId;
    void *Reserved;
    } 	FABRIC_HEALTH_INFORMATION_EX1;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH_REPORT
    {
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_INSTANCE_ID InstanceId;
    const FABRIC_HEALTH_INFORMATION *HealthInformation;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH_REPORT;
...
typedef struct FABRIC_LOAD_METRIC_INFORMATION_EX4
    {
    DOUBLE PlannedLoadRemoval;
    void *Reserved;
    } 	FABRIC_LOAD_METRIC_INFORMATION_EX4;
...
typedef struct FABRIC_PARTITION_LOAD_INFORMATION_EX1
    {
    FABRIC_LOAD_METRIC_REPORT_LIST *AuxiliaryLoadMetricReports;
    void *Reserved;
    } 	FABRIC_PARTITION_LOAD_INFORMATION_EX1;

typedef struct FABRIC_PARTITION_LOAD_INFORMATION_EX2
    {
    FABRIC_LOAD_METRIC_REPORT_LIST *MaximumLoadMetricReports;
    void *Reserved;
    } 	FABRIC_PARTITION_LOAD_INFORMATION_EX2;
...
typedef struct FABRIC_METRIC_LOAD_DESCRIPTION
    {
    LPCWSTR MetricName;
    ULONG CurrentLoad;
    BOOLEAN IsCurrentLoadSpecified;
    ULONG PredictedLoad;
    BOOLEAN IsPredictedLoadSpecified;
    void *Reserved;
    } 	FABRIC_METRIC_LOAD_DESCRIPTION;

typedef struct FABRIC_METRIC_LOAD_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_METRIC_LOAD_DESCRIPTION *Items;
    } 	FABRIC_METRIC_LOAD_DESCRIPTION_LIST;

typedef struct FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION
    {
    LPCWSTR NodeName;
    FABRIC_METRIC_LOAD_DESCRIPTION_LIST *ReplicaOrInstanceLoadEntries;
    void *Reserved;
    } 	FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION;

typedef struct FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION *Items;
    } 	FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION_LIST;

typedef struct FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION
    {
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_METRIC_LOAD_DESCRIPTION_LIST *PrimaryReplicaLoadEntries;
    FABRIC_METRIC_LOAD_DESCRIPTION_LIST *SecondaryReplicasOrInstancesLoadEntries;
    FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION_LIST *SecondaryReplicaOrInstanceLoadEntriesPerNode;
    void *Reserved;
    } 	FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION;

typedef struct FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_EX1
    {
    FABRIC_METRIC_LOAD_DESCRIPTION_LIST *AuxiliaryReplicasLoadEntries;
    FABRIC_REPLICA_METRIC_LOAD_DESCRIPTION_LIST *AuxiliaryReplicaLoadEntriesPerNode;
    void *Reserved;
    } 	FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_EX1;

typedef struct FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_EX2
    {
    FABRIC_METRIC_LOAD_DESCRIPTION_LIST *MaximumReplicaLoadEntries;
    void *Reserved;
    } 	FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_EX2;

typedef struct FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION *Items;
    } 	FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_LIST;

typedef struct FABRIC_UPDATE_PARTITION_LOAD_QUERY_DESCRIPTION
    {
    FABRIC_PARTITION_METRIC_LOAD_DESCRIPTION_LIST *PartitionMetricLoadDescriptionList;
    LPCWSTR ContinuationToken;
    LONG MaxResults;
    void *Reserved;
    } 	FABRIC_UPDATE_PARTITION_LOAD_QUERY_DESCRIPTION;

typedef struct FABRIC_UPDATE_PARTITION_LOAD_QUERY_RESULT_ITEM
    {
    FABRIC_PARTITION_ID PartitionId;
    HRESULT ErrorCode;
    void *Reserved;
    } 	FABRIC_UPDATE_PARTITION_LOAD_QUERY_RESULT_ITEM;

typedef struct FABRIC_UPDATE_PARTITION_LOAD_QUERY_RESULT_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_UPDATE_PARTITION_LOAD_QUERY_RESULT_ITEM *Items;
    } 	FABRIC_UPDATE_PARTITION_LOAD_QUERY_RESULT_LIST;

typedef struct FABRIC_REPLICA_MOVE_COST_DESCRIPTION
    {
    LPCWSTR NodeName;
    FABRIC_MOVE_COST ReplicaOrInstanceMoveCostEntry;
    void *Reserved;
    } 	FABRIC_REPLICA_MOVE_COST_DESCRIPTION;

typedef struct FABRIC_REPLICA_MOVE_COST_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_REPLICA_MOVE_COST_DESCRIPTION *Items;
    } 	FABRIC_REPLICA_MOVE_COST_DESCRIPTION_LIST;

typedef struct FABRIC_PARTITION_MOVE_COST_DESCRIPTION
    {
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_MOVE_COST PrimaryReplicaMoveCostEntry;
    BOOLEAN IsPrimaryReplicaMoveCostEntrySpecified;
    FABRIC_MOVE_COST SecondaryReplicasOrInstancesMoveCostEntry;
    BOOLEAN IsSecondaryReplicasOrInstancesMoveCostEntrySpecified;
    FABRIC_REPLICA_MOVE_COST_DESCRIPTION_LIST *SecondaryReplicaOrInstanceMoveCostEntriesPerNode;
    FABRIC_MOVE_COST AuxiliaryReplicasMoveCostEntry;
    BOOLEAN IsAuxiliaryReplicasMoveCostEntrySpecified;
    FABRIC_REPLICA_MOVE_COST_DESCRIPTION_LIST *AuxiliaryReplicaMoveCostEntriesPerNode;
    void *Reserved;
    } 	FABRIC_PARTITION_MOVE_COST_DESCRIPTION;

typedef struct FABRIC_PARTITION_MOVE_COST_DESCRIPTION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_PARTITION_MOVE_COST_DESCRIPTION *Items;
    } 	FABRIC_PARTITION_MOVE_COST_DESCRIPTION_LIST;

typedef struct FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_DESCRIPTION
    {
    FABRIC_PARTITION_MOVE_COST_DESCRIPTION_LIST *PartitionMoveCostDescriptionList;
    LPCWSTR ContinuationToken;
    LONG MaxResults;
    void *Reserved;
    } 	FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_DESCRIPTION;

typedef struct FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_RESULT_ITEM
    {
    FABRIC_PARTITION_ID PartitionId;
    HRESULT ErrorCode;
    void *Reserved;
    } 	FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_RESULT_ITEM;

typedef struct FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_RESULT_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_RESULT_ITEM *Items;
    } 	FABRIC_UPDATE_PARTITION_MOVE_COST_QUERY_RESULT_LIST;
...
typedef struct FABRIC_NODE_LOAD_METRIC_INFORMATION_EX3
    {
    DOUBLE PlannedNodeLoadRemoval;
    void *Reserved;
    } 	FABRIC_NODE_LOAD_METRIC_INFORMATION_EX3;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH
    {
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_INSTANCE_ID InstanceId;
    FABRIC_HEALTH_STATE AggregatedHealthState;
    ...
    const FABRIC_HEALTH_EVALUATION_LIST *UnhealthyEvaluations;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH_STATE
    {
    FABRIC_PARTITION_ID PartitionId;
    FABRIC_INSTANCE_ID InstanceId;
    FABRIC_HEALTH_STATE AggregatedHealthState;
...
typedef struct FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH_STATE_EX1
    {
    const FABRIC_HEALTH_EVALUATION_LIST *UnhealthyEvaluations;
    void *Reserved;
    } 	FABRIC_SELF_RECONFIGURING_SERVICE_INSTANCE_HEALTH_STATE_EX1;
...
typedef struct FABRIC_APPLICATION_PRINCIPALS_DESCRIPTION_EX1
    {
    const FABRIC_MANAGED_IDENTITY_DESCRIPTION_LIST *ManagedIdentities;
    LPCWSTR TokenServiceEndpoint;
    LPCWSTR DefaultIdentity;
    BOOLEAN UseServiceLevelIdentities;
    void *Reserved;
    } 	FABRIC_APPLICATION_PRINCIPALS_DESCRIPTION_EX1;
...
typedef struct FABRIC_APPLICATION_UPGRADE_PROGRESS_EX3
    {
    DWORD HealthCheckElapsedTime;
    FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE HealthCheckPhase;
    LONGLONG HealthCheckFlips;
    void *Reserved;
    } 	FABRIC_APPLICATION_UPGRADE_PROGRESS_EX3;
...
typedef struct FABRIC_UPGRADE_PROGRESS_EX2
    {
    DWORD HealthCheckElapsedTime;
    FABRIC_MONITORED_UPGRADE_HEALTH_CHECK_PHASE HealthCheckPhase;
    LONGLONG HealthCheckFlips;
    void *Reserved;
    } 	FABRIC_UPGRADE_PROGRESS_EX2;
...
typedef struct FABRIC_NODE_TYPE_HEALTH_POLICY_MAP_ITEM
    {
    LPCWSTR NodeTypeName;
    BYTE MaxPercentUnhealthyNodes;
    } 	FABRIC_NODE_TYPE_HEALTH_POLICY_MAP_ITEM;

typedef struct FABRIC_NODE_TYPE_HEALTH_POLICY_MAP
    {
    ULONG Count;
    /* [size_is] */ const FABRIC_NODE_TYPE_HEALTH_POLICY_MAP_ITEM *Items;
    } 	FABRIC_NODE_TYPE_HEALTH_POLICY_MAP;

typedef struct FABRIC_CLUSTER_HEALTH_POLICY_EX2
    {
    const FABRIC_NODE_TYPE_HEALTH_POLICY_MAP *NodeTypeHealthPolicyMap;
    void *Reserved;
    } 	FABRIC_CLUSTER_HEALTH_POLICY_EX2;

typedef struct FABRIC_NODE_TYPE_NODES_HEALTH_EVALUATION
    {
    LPCWSTR Description;
    FABRIC_HEALTH_STATE AggregatedHealthState;
    LPCWSTR NodeTypeName;
    ...
    BYTE MaxPercentUnhealthyNodes;
    void *Reserved;
    } 	FABRIC_NODE_TYPE_NODEs_HEALTH_EVALUATION;
...
typedef struct FABRIC_ROLLING_UPGRADE_POLICY_DESCRIPTION_EX4
    {
    FABRIC_UPGRADE_SORT_ORDER UpgradeSortOrder;
    void *Reserved;
    } 	FABRIC_ROLLING_UPGRADE_POLICY_DESCRIPTION_EX4;

typedef struct FABRIC_ROLLING_UPGRADE_POLICY_DESCRIPTION_EX5
    {
    DWORD InstanceCloseDelayDurationInSeconds;
    void *Reserved;
    } 	FABRIC_ROLLING_UPGRADE_POLICY_DESCRIPTION_EX5;
...
typedef struct FABRIC_MANAGED_IDENTITY_TOKEN_SERVICE_DESCRIPTION
    {
    BOOLEAN IsTokenServiceEnabled;
    BOOLEAN IsClusterIdentityEnabled;
    LPCWSTR ApplicationTokenEndpoint;
    LPCWSTR SystemTokenEndpoint;
    LPCWSTR ClusterIdentityObjectId;
    LPCWSTR RemoteTokenEndpoint;
    LPCWSTR ServerCertificateThumbprint;
    void *Reserved;
    } 	FABRIC_MANAGED_IDENTITY_TOKEN_SERVICE_DESCRIPTION;
...
enum FABRIC_CODE_PACKAGE_EVENT_TYPE
    {
        ...
        FABRIC_CODE_PACKAGE_EVENT_TYPE_RAN_TO_COMPLETION	= 0x7
    } 	FABRIC_CODE_PACKAGE_EVENT_TYPE;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("ebbb5d76-9806-4f77-bec3-4e9037682fe7") 
enum FABRIC_SERVICE_HOST_UPGRADE_IMPACT
    {
        FABRIC_SERVICE_HOST_UPGRADE_IMPACT_INVALID	= 0,
        FABRIC_SERVICE_HOST_UPGRADE_IMPACT_NONE	= 0x1,
        FABRIC_SERVICE_HOST_UPGRADE_IMPACT_SERVICE_HOST_RESTART	= 0x2,
        FABRIC_SERVICE_HOST_UPGRADE_IMPACT_UNEXPECTED_SERVICE_HOST_RESTART	= 0x3
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("FD5EE929-8F43-4268-BA9A-B9536BA3CF95") 
enum FABRIC_EXECUTION_POLICY_EXECUTION_TYPE
    {
        FABRIC_EXECUTION_POLICY_EXECUTION_TYPE_RUN_ALWAYS	= 0,
        FABRIC_EXECUTION_POLICY_EXECUTION_TYPE_RUN_TO_COMPLETION	= 0x1
    } 	FABRIC_EXECUTION_POLICY_EXECUTION_TYPE;

typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("EC87B865-16AB-4E7D-BB28-0785A0F96CB4") 
enum FABRIC_EXECUTION_POLICY_RESTART_POLICY
    {
        FABRIC_EXECUTION_POLICY_RESTART_POLICY_ALWAYS	= 0,
        FABRIC_EXECUTION_POLICY_RESTART_POLICY_ON_FAILURE	= 0x1,
        FABRIC_EXECUTION_POLICY_RESTART_POLICY_NEVER	= 0x2
    } 	FABRIC_EXECUTION_POLICY_RESTART_POLICY;

typedef struct FABRIC_EXECUTION_POLICY_DESCRIPTION
    {
    FABRIC_EXECUTION_POLICY_EXECUTION_TYPE ExecutionType;
    FABRIC_EXECUTION_POLICY_RESTART_POLICY RestartPolicy;
    } 	FABRIC_EXECUTION_POLICY_DESCRIPTION;

typedef struct FABRIC_CODE_PACKAGE_ACTIVATION_INFORMATION
    {
    LPCWSTR CodePackageName;
    FABRIC_EXECUTION_POLICY_DESCRIPTION *ExecutionPolicy;
    } 	FABRIC_CODE_PACKAGE_ACTIVATION_INFORMATION;

typedef struct FABRIC_CODE_PACKAGE_ACTIVATION_INFORMATION_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_CODE_PACKAGE_ACTIVATION_INFORMATION *Items;
    } 	FABRIC_CODE_PACKAGE_ACTIVATION_INFORMATION_LIST;
