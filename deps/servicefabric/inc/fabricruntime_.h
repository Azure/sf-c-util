...
#ifndef __IFabricOperationDataStream2_FWD_DEFINED__
#define __IFabricOperationDataStream2_FWD_DEFINED__
typedef interface IFabricOperationDataStream2 IFabricOperationDataStream2;

#endif 	/* __IFabricOperationDataStream2_FWD_DEFINED__ */
...
#ifndef __IFabricOperationDataStream2_INTERFACE_DEFINED__
#define __IFabricOperationDataStream2_INTERFACE_DEFINED__

/* interface IFabricOperationDataStream2 */
/* [uuid][local][object] */ 


EXTERN_C const IID IID_IFabricOperationDataStream2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("469febc8-30c6-4d47-9202-4de365b0142b")
    IFabricOperationDataStream2 : public IFabricOperationDataStream
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE EndGetNext2( 
            /* [in] */ IFabricAsyncOperationContext *context,
            /* [retval][out] */ void **operationData) = 0;
    ...
    typedef struct IFabricOperationDataStream2Vtbl
    {
        BEGIN_INTERFACE
        ...
        HRESULT ( STDMETHODCALLTYPE *EndGetNext2 )( 
            IFabricOperationDataStream2 * This,
            /* [in] */ IFabricAsyncOperationContext *context,
            /* [retval][out] */ void **operationData);
        
        END_INTERFACE
    } IFabricOperationDataStream2Vtbl;

    interface IFabricOperationDataStream2
    {
        CONST_VTBL struct IFabricOperationDataStream2Vtbl *lpVtbl;
    };
...
#define IFabricOperationDataStream2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IFabricOperationDataStream2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IFabricOperationDataStream2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IFabricOperationDataStream2_BeginGetNext(This,callback,context)	\
    ( (This)->lpVtbl -> BeginGetNext(This,callback,context) ) 

#define IFabricOperationDataStream2_EndGetNext(This,context,operationData)	\
    ( (This)->lpVtbl -> EndGetNext(This,context,operationData) ) 


#define IFabricOperationDataStream2_EndGetNext2(This,context,operationData)	\
    ( (This)->lpVtbl -> EndGetNext2(This,context,operationData) ) 
...
#endif 	/* __IFabricOperationDataStream2_INTERFACE_DEFINED__ */
