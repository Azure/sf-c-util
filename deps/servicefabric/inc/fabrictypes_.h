...
typedef GUID FABRIC_BRS_OPERATION_ID;
...
enum FABRIC_EXTENTLOG_LOG_SETTINGS_FLAGS
    {
        FABRIC_EXTENTLOG_LOG_SETTINGS_NONE	= 0,
        FABRIC_EXTENTLOG_LOG_SETTINGS_NEW_EXTENT_THRESHOLD	= 0x1,
        FABRIC_EXTENTLOG_LOG_SETTINGS_INITIAL_NUM_FREE_EXTENTS	= 0x2,
        FABRIC_EXTENTLOG_LOG_SETTINGS_PAGE_SIZE_KB	= 0x4
    } 	FABRIC_EXTENTLOG_LOG_SETTINGS_FLAGS;
...
enum FABRIC_QUERY_RESULT_ITEM_KIND
    {
        ...
        FABRIC_QUERY_RESULT_ITEM_KIND_CONFIGURATION_PARAMETER_OVERRIDE	= 0x37,
        FABRIC_QUERY_RESULT_ITEM_KIND_UPDATE_PARTITION_LOAD	= 0x38,
        FABRIC_QUERY_RESULT_ITEM_KIND_LOADED_PARTITION_INFORMATION	= 0x39,
        FABRIC_QUERY_RESULT_ITEM_KIND_UPDATE_PARTITION_MOVE_COST	= 0x3a,
        FABRIC_QUERY_RESULT_ITEM_KIND_AUTHORIZED_CONNECTION	= 0x3b,
        FABRIC_QUERY_RESULT_ITEM_KIND_BLOCK_LIST	= 0x3c
...
typedef struct EXTENTLOGGER_LOG_SETTINGS
    {
    DWORD64 Flags;
    ULONG ExtentLogThresholdForNewWriteExtentInMB;
    ULONG ExtentLogInitialNumFreeExtents;
    ULONG ExtentLogPageSizeInKB;
    } 	EXTENTLOGGER_LOG_SETTINGS;
...
typedef struct TRANSACTIONAL_REPLICATOR_SETTINGS
    ...
    DWORD CopyBatchSizeInKB;
    DWORD LoggingEngine;
    EXTENTLOGGER_LOG_SETTINGS ExtentLogSettings;
    void *Reserved;
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("ccc6d553-dac1-4c3f-9e39-13f122e82048") 
enum FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND
    {
        FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND_INVALID	= 0,
        FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND_VMSS	= 0x1,
        FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND_CLUSTER	= 0x2
    } 	FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND;
...
enum FABRIC_BACKUP_STORE_TYPE
    {
        ...
        FABRIC_BACKUP_STORE_TYPE_KV_AZURE_STORE	= 0x4,
        FABRIC_BACKUP_STORE_TYPE_MANAGED_IDENTITY_AZURE_STORE	= 0x5
...
typedef struct FABRIC_SERVICE_TRANSPORT_SETTINGS_EX2
    {
    BOOLEAN EnableMaxConcurrentCalls;
    void *Reserved;
    } 	FABRIC_SERVICE_TRANSPORT_SETTINGS_EX2;
...
typedef struct FABRIC_BACKUP_STORE_KEY_VAULT_INFORMATION
    {
    LPCWSTR BaseUri;
    LPCWSTR SecretName;
    void *Reserved;
    } 	FABRIC_BACKUP_STORE_KEY_VAULT_INFORMATION;

typedef struct FABRIC_BACKUP_STORE_KEY_VAULT_AUTH_INFORMATION
    {
    LPCWSTR ApplicationClientId;
    LPCWSTR CertificateSubject;
    LPCWSTR CertificateIssuerThumbprint;
    LPCWSTR StoreName;
    void *Reserved;
    } 	FABRIC_BACKUP_STORE_KEY_VAULT_AUTH_INFORMATION;

typedef struct FABRIC_BACKUP_STORE_KEY_VAULT_AZURE_STORAGE_INFORMATION
    {
    const FABRIC_BACKUP_STORE_KEY_VAULT_AUTH_INFORMATION *KeyVaultAuthInformation;
    const FABRIC_BACKUP_STORE_KEY_VAULT_INFORMATION *KeyVaultInformation;
    LPCWSTR ContainerName;
    LPCWSTR FolderPath;
    void *Reserved;
    } 	FABRIC_BACKUP_STORE_KEY_VAULT_AZURE_STORAGE_INFORMATION;

typedef struct FABRIC_BACKUP_STORE_MANAGED_IDENTITY_AZURE_STORAGE_INFORMATION
    {
    LPCWSTR BlobServiceUri;
    LPCWSTR ContainerName;
    FABRIC_BACKUP_STORE_MANAGED_IDENTITY_KIND ManagedIdentityType;
    LPCWSTR FolderPath;
    void *Reserved;
    } 	FABRIC_BACKUP_STORE_MANAGED_IDENTITY_AZURE_STORAGE_INFORMATION;

typedef struct FABRIC_BACKUP_STORE_MANAGED_IDENTITY_AZURE_STORAGE_INFORMATION_EX1
    {
    GUID ManagedIdentityClientId;
    void *Reserved;
    } 	FABRIC_BACKUP_STORE_MANAGED_IDENTITY_AZURE_STORAGE_INFORMATION_EX1;
...
typedef struct FABRIC_BACKUP_UPLOAD_INFO_EX1
    {
    FABRIC_BRS_OPERATION_ID OperationId;
    void *Reserved;
    } 	FABRIC_BACKUP_UPLOAD_INFO_EX1;
...
typedef struct FABRIC_BACKUP_DOWNLOAD_INFO_EX1
    {
    FABRIC_BRS_OPERATION_ID OperationId;
    void *Reserved;
    } 	FABRIC_BACKUP_DOWNLOAD_INFO_EX1;
...
enum FABRIC_CONTAINER_NETWORK_TYPE
    {
        ...
        FABRIC_CONTAINER_NETWORK_TYPE_DELEGATED	= 0x4
    } 	FABRIC_CONTAINER_NETWORK_TYPE;

typedef struct FABRIC_CONTAINER_DNS_CONFIG_DESCRIPTION
    {
    FABRIC_STRING_LIST *NameServers;
    LPCWSTR LocalDomain;
    FABRIC_STRING_LIST *SearchDomains;
    FABRIC_STRING_LIST *Options;
    void *Reserved;
    } 	FABRIC_CONTAINER_DNS_CONFIG_DESCRIPTION;

typedef struct FABRIC_NETWORK_RESOURCE
    {
    LPCWSTR ServicePackageId;
    LPCWSTR CodePackageName;
    LPCWSTR NetworkName;
    LPCWSTR NetworkType;
    LPCWSTR PodNamespace;
    LPCWSTR PodName;
    LPCWSTR NetworkContainerId;
    LPCWSTR IpAddress;
    LPCWSTR MacAddress;
    FABRIC_STRING_PAIR_LIST *PortBindings;
    FABRIC_STRING_PAIR_LIST *NetworkProperties;
    FABRIC_CONTAINER_DNS_CONFIG_DESCRIPTION *DnsConfig;
    void *Reserved;
    } 	FABRIC_NETWORK_RESOURCE;

typedef struct FABRIC_NETWORK_RESOURCE_LIST
    {
    ULONG Count;
    /* [size_is] */ FABRIC_NETWORK_RESOURCE *Items;
    } 	FABRIC_NETWORK_RESOURCE_LIST;
...
typedef struct FABRIC_CONTAINER_NETWORK_CONFIG_DESCRIPTION_EX1
    {
    FABRIC_NETWORK_RESOURCE_LIST *NetworkResources;
    void *Reserved;
    } 	FABRIC_CONTAINER_NETWORK_CONFIG_DESCRIPTION_EX1;
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("CA78ED3B-2774-4BAE-87BE-C7003C07B789") 
enum FABRIC_MANAGED_IDENTITY_REFERENCE_KIND
    {
        FABRIC_MANAGED_IDENTITY_NONE	= 0,
        FABRIC_MANAGED_IDENTITY_HOST	= 1,
        FABRIC_MANAGED_IDENTITY_SERVICE	= 2,
        FABRIC_MANAGED_IDENTITY_CLUSTER	= 3
    } 	FABRIC_MANAGED_IDENTITY_REFERENCE_KIND;

typedef struct FABRIC_REPOSITORY_AUTHENTICATION_DESCRIPTION
    {
    FABRIC_MANAGED_IDENTITY_REFERENCE_KIND IdentityKind;
    LPCWSTR IdentityRef;
    void *Reserved;
    } 	FABRIC_REPOSITORY_AUTHENTICATION_DESCRIPTION;
...
typedef struct FABRIC_CONTAINER_HEALTH_CONFIG_DESCRIPTION_EX1
    {
    BOOLEAN TreatContainerUnhealthyStatusAsError;
    void *Reserved;
    } 	FABRIC_CONTAINER_HEALTH_CONFIG_DESCRIPTION_EX1;
...
typedef struct FABRIC_RESOURCE_GOVERNANCE_POLICY_DESCRIPTION_EX2
    {
    ULONG MemoryInMBLimit;
    void *Reserved;
    } 	FABRIC_RESOURCE_GOVERNANCE_POLICY_DESCRIPTION_EX2;

typedef struct FABRIC_RESOURCE_GOVERNANCE_POLICY_DESCRIPTION_EX3
    {
    DOUBLE CpuCores;
    DOUBLE CpuCoresLimit;
    void *Reserved;
    } 	FABRIC_RESOURCE_GOVERNANCE_POLICY_DESCRIPTION_EX3;
...
typedef struct FABRIC_SERVICE_PACKAGE_RESOURCE_GOVERNANCE_DESCRIPTION_EX1
    {
    DOUBLE CpuCoresLimit;
    ULONG MemoryInMBLimit;
    void *Reserved;
    } 	FABRIC_SERVICE_PACKAGE_RESOURCE_GOVERNANCE_DESCRIPTION_EX1;
...
typedef struct FABRIC_PROCESS_DESCRIPTION_EX2
    {
    BOOLEAN ArgumentsBase64Encoded;
    void *Reserved;
    } 	FABRIC_PROCESS_DESCRIPTION_EX2;
...
typedef struct FABRIC_CONTAINER_IMAGE_DESCRIPTION_EX3
    {
    FABRIC_REPOSITORY_AUTHENTICATION_DESCRIPTION *RepositoryAuthentication;
    void *Reserved;
    } 	FABRIC_CONTAINER_IMAGE_DESCRIPTION_EX3;
...
enum FABRIC_CONTAINER_EVENT_TYPE
    {
        ...
        FABRIC_CONTAINER_EVENT_TYPE_EXEC_DIE	= 0x4
...
typedef struct FABRIC_CONTAINER_EVENT_DESCRIPTION_EX1
    {
    LPCWSTR ExecID;
    void *Reserved;
    } 	FABRIC_CONTAINER_EVENT_DESCRIPTION_EX1;
...
typedef /* [uuid][v1_enum] */  DECLSPEC_UUID("90378bc8-3ce0-4782-a59d-ce5da0416a80") 
enum FABRIC_AUTHORIZED_CONNECTION_KEYTYPE
    {
        FABRIC_AUTHORIZED_CONNECTION_INVALID	= 0,
        FABRIC_AUTHORIZED_CONNECTION_BASE64_DER_CERTIFICATE	= 0x1
    } 	FABRIC_AUTHORIZED_CONNECTION_KEYTYPE;

typedef struct FABRIC_AUTHORIZED_CONNECTION_REQUEST
    {
    LPCWSTR ClientPublicKey;
    LPCWSTR ClientAddress;
    ULONG ClientPort;
    FABRIC_AUTHORIZED_CONNECTION_KEYTYPE KeyType;
    void *Reserved;
    } 	FABRIC_AUTHORIZED_CONNECTION_REQUEST;

typedef struct FABRIC_AUTHORIZED_CONNECTION_RESULT
    {
    LPCWSTR ServerPublicKey;
    LPCWSTR ServerAddress;
    ULONG ServerPort;
    GUID AuthorizedConnectionIdentifier;
    FABRIC_AUTHORIZED_CONNECTION_KEYTYPE KeyType;
    void *Reserved;
    } 	FABRIC_AUTHORIZED_CONNECTION_RESULT;
