...
const FABRIC_CONFIGURATION_PACKAGE_DESCRIPTION* real_IFabricConfigurationPackage_get_Description(FC_PACKAGE_HANDLE fc_package_handle);
LPCWSTR real_IFabricConfigurationPackage_get_Path(FC_PACKAGE_HANDLE fc_package_handle);
const FABRIC_CONFIGURATION_SETTINGS* real_IFabricConfigurationPackage_get_Settings(FC_PACKAGE_HANDLE fc_package_handle);
HRESULT real_IFabricConfigurationPackage_GetSection(FC_PACKAGE_HANDLE fc_package_handle,
    /* [in] */ LPCWSTR sectionName,
    /* [retval][out] */ const FABRIC_CONFIGURATION_SECTION** bufferedValue);
HRESULT real_IFabricConfigurationPackage_GetValue(FC_PACKAGE_HANDLE fc_package_handle,
    /* [in] */ LPCWSTR sectionName,
