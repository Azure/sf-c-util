...
#define TEST_SF_SERVICE_CONFIG_DO_ASSIGN_IF_MATCH_double(type, name) MU_IF(TEST_SF_SERVICE_CONFIG_TYPE_IS_double(type), TEST_SF_SERVICE_CONFIG_DO_ASSIGN_IF_MATCH(name), )
...
#define TEST_SF_SERVICE_CONFIG_VALUE_TO_RETURN_INIT_MAX_double(name) TEST_SF_SERVICE_CONFIG_VALUE_TO_RETURN(name) = DBL_MAX - DBL_MIN;
...
#define TEST_SF_SERVICE_CONFIG_VALUE_TO_RETURN_CLEANUP_double(type, name) TEST_SF_SERVICE_CONFIG_VALUE_TO_RETURN_INIT_DEFAULT(type, name)
