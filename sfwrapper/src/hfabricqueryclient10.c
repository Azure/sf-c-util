...
#include "hfabricqueryclient10.h"
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetNodeList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationTypeList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceTypeList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetPartitionList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetReplicaList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedApplicationList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedServicePackageList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedServiceTypeList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedCodePackageList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedReplicaList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedReplicaDetail,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetClusterLoadInformation,
    IN_ARGS(
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetPartitionLoadInformation,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetProvisionedFabricCodeVersionList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetProvisionedFabricConfigVersionList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetNodeLoadInformation,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetReplicaLoadInformation,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceGroupMemberList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceGroupMemberTypeList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetUnplacedReplicaInformation,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetNodeList2,
    IN_ARGS(
        ARG(const FABRIC_NODE_QUERY_DESCRIPTION*, queryDescription),
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationList2,
    IN_ARGS(
        ARG(const FABRIC_APPLICATION_QUERY_DESCRIPTION*, queryDescription),
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceList2,
    IN_ARGS(
        ARG(const FABRIC_SERVICE_QUERY_DESCRIPTION*, queryDescription),
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetPartitionList2,
    IN_ARGS(
        ARG(const FABRIC_SERVICE_PARTITION_QUERY_DESCRIPTION*, queryDescription),
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetReplicaList2,
    IN_ARGS(
        ARG(const FABRIC_SERVICE_REPLICA_QUERY_DESCRIPTION*, queryDescription),
        ARG(DWORD, timeoutMilliseconds),
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationLoadInformation,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetServiceName,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationName,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetApplicationTypePagedList,
    IN_ARGS(
...
H_FABRIC_DEFINE_API(IFabricQueryClient10, FQC10_GetDeployedApplicationPagedList,
    IN_ARGS(
